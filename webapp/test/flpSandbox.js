		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Invoices List",
									"targetURL": "#dbtrustinvoices-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"dbtrustinvoices-display": {
								"semanticObject": "dbtrustinvoices",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=dbtrust.invoices",
									"url": sap.ui.require.toUrl("dbtrust/invoices")
								}
							}
						}
					}
